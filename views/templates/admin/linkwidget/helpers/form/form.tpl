...
{block name="input_row"}
            ...
            {foreach $input.values as $key => $link_blocks_position name='blocksLoop'}
                <div class="col-lg-6">
                    <div class="panel">
                        ...
                        <table class="table tableDnD cms" id="link_block_{$link_blocks_position.id_hook}">
                            <thead>
                                        ...
                                        <td>
                                            <div class="btn-group-action">
                                                <div class="btn-group pull-right">
                                                    <a class="btn btn-default" href="{$current}&amp;edit{$identifier}&amp;id_link_block={(int)$link_block['id_link_block']}" title="{l s='Edit' mod='linksmanager'}">
                                                        <i class="icon-edit"></i> {l s='Edit' mod='linksmanager'}
                                                    </a>
                                                    ...
                                                    <li>
                                                        <a href="{$current}&amp;delete{$identifier}&amp;id_link_block={(int)$link_block['id_link_block']}" title="{l s='Delete' mod='linksmanager'}">
                                                            <i class="icon-trash"></i> {l s='Delete' mod='linksmanager'}
                                                        </a>
                                                    </li>
                                                    </ul>
                                                </div>
    ...
    <div class="panel link-selector">
        ...
        <ul id="repository-list">
          ...
          <li class="list-subtitle">{l s='Static pages' mod='linksmanager'}</li>
